...
function t4() {
    a4_res = a4.filter(v => typeof(v) == 'number');
    return a4_res;
}
...
function t5() {
    a5_res = a5.filter(v => typeof(v) == 'number' && v % 2 == 0);
    return a5_res;
}
...
function t6() {
    a6_res = a6.filter(v => typeof(v) == 'number' && v > 14);
    return a6_res;
}
...
function t9() {
    ...
    a9.forEach((v, i) => a9[i] = v.toLowerCase());
    return a9;
}
...
function t14() {
//filteredStrings = filterstrings.filter((str) => 
//str.toLowerCase().includes(passedinstring.toLowerCase())
   // return a14.filter(s => s.toLowerCase().includes(a14_sym.toLocaleLowerCase));
   let res = a14.includes(a14_sym.toUpperCase());
   if(!res){
    res = a14.includes(a14_sym.toLowerCase());
   }
   return res;
}
...
function t15() {
    a15_res = a15.filter(v => v['pnum'] != null && v['pnum'].length == 6);
