...
function f8() {
   let input = +document.querySelector('.s-8').value;
   let res;
   switch (input) {
...
function f10() {
   ...
   document.querySelector('.out-10').innerHTML = input;
}
...
function f11() {
   let input = document.querySelector('.s-110').value;
   document.querySelector('.out-11').innerHTML = input;
}
