...
function t9() {
    let res = '';
    let min = document.querySelector('.i-91').value;
    let max = document.querySelector('.i-92').value;
    if(min > max) {
        [min, max] = [max, min];
    }
    while(min <= max){
...
function t11() {
    let res = '';
    let i = 0;
    let elems = document.querySelectorAll('div.div-11');
    while(i < elems.length){
        res += elems[i].innerHTML + '_';
        i++;
    }
...
function t12() {
    let i = 0;
    let elems = document.querySelectorAll('div.div-12');
    while(i < elems.length){
