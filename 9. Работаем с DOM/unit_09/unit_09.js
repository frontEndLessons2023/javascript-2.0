...
function f3() {
    document.querySelector('.out-3').classList.toggle("bg-orange");
}
...
function f5() {
    let res = document.querySelector('.out-4').className;
    document.querySelector('.out-5').innerHTML = res.includes("bg-orange");
}
...
function f6() {
    let res = document.querySelectorAll('.p-6').length;
...
function f18() {
    attribute = document.querySelector('.p-18').getAttribute('data-b');
...
function f19() {
    let attributs = document.querySelectorAll('.p-19');
    let res = '';
    for(let i = 0; i < attributs.length; i++){
        res += attributs[i].getAttribute('data-b') + " ";
    }
...
function f20() {
    let tmp = document.querySelector('.out-20');
    tmp.setAttribute('title', 'go');
}
