...
function f4() {
    ...
    document.querySelector('.out-4').innerHTML = val.checked;
}
...
function f5() {
    let val = document.querySelector('.i-5');
    let isChecked = val.checked;
    let res = document.querySelector('.out-5');
    if(isChecked){
        res.innerHTML = val.value;
    } else {
        res.innerHTML = isChecked;
    }
}
...
document.querySelector('div.out-71').innerHTML = val;
let res = document.querySelector('div.out-72')
if(val.length  >= 6){
    res.innerHTML = 1;
} else {
    res.innerHTML = 0;
...
function f8() {
    document.querySelector('div.out-8').innerHTML = '<div class="js2">new div</div>';
}
...
function f9() {
    let res = document.querySelector('div.out-9');
    let btn = document.querySelector('.r-9');
    if(btn.checked){
        res.innerHTML = btn.value;
    } else {
        res.innerHTML = btn.checked;
    }
...
function f10() {
    ...
    document.querySelector('div.out-10').style.backgroundColor = 
    color;
}
...
document.querySelector('.i-13').onchange = f13;
function f13() {
...
function f14() {
    let res = document.querySelector('.t-14').value;
...
function f15() {
    let res = document.querySelector('.i-15').value;
    document.querySelector('.out-15').innerHTML = res;
    document.querySelector('.t-15').innerHTML = res;
}
...
function f16() {
    ...
    let res = document.querySelector('.s-16').value;
...
function f17() {
    let res = document.querySelector('.s-17').value;
...
function f18() {
    let res = document.querySelector('.s-18').value;
    document.querySelector('.i-18').value = res;
}
...
function f19() {
    let res = document.querySelector('.out-19').textContent;
    document.querySelector('.i-19').value = res;
}
...
function f20() {
    let res = document.querySelector('.s-201').value;
    document.querySelector('.s-202').value = res;
}
