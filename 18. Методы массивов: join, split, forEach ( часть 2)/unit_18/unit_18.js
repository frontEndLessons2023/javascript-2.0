...
function t3() {
    a3.forEach(e => typeof(e) == 'number' ? a3_res.push(e) : e);
...
function t4() {
    document.querySelectorAll('span.task-4')
    .forEach(e => a4_res.push(e.textContent));
...
function t5() {
    a5_res.push(this.attributes.data);
...
function t10() {
    ...
    for (let key in a10) {
        if (a10.hasOwnProperty(key)) {
            res.push(key + '=' + encodeURIComponent(a10[key]));
        }
    }
    a10_res = res.join('&');
    console.log(a10_res);
