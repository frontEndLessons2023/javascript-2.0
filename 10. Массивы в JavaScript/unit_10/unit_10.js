...
let ar1 = [1, 12, 'Hello', 14, true, 15 < 10, 144];
function f1() {
...
let ar2 = [1, 12, 'Hello', 14, true, 15 < 10, 144];
function f2() {
    let out = '';
...
let ar3 = [1, 12, 'Hello', 14, true, 15 < 10, 144];
function f3() {
...
// let ar6 =
let ar6 = ["Nataliia", "Virgo", "31", "August"];
...
function f16() {
    ...
    document.querySelector('.out-16-even').innerHTML = res_even;
    document.querySelector('.out-16-odd').innerHTML = res_odd;
}
