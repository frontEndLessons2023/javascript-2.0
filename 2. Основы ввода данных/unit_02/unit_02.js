...
function t9() {
    ...
    document.querySelector('div.out-9').innerHTML = data;
...
function t10() {
    ...
    document.querySelector('div.out-10').innerHTML = data * 20;
...
function t11() {
    ...
    document.querySelector('div.out-11').innerHTML = data + 55;
...
function t12() {
    ...
    document.querySelector('div.out-12').innerHTML = 'Hello ' + name + ' ' + surname;
}
...
function t13() {
    ...
    document.querySelector('div.out-13').innerHTML = num1 + num2;
}
...
function t16() {
    ...
    document.querySelector('div.out-16').innerHTML = num1 + num2;
}
...
function t19() {
    ...
    document.querySelector('div.out-19').innerHTML = num1 + num2;
}
...
function t20() {
    ...
    document.querySelector('div.out-20').innerHTML = count;
}
