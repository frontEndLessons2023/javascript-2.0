...
const webSite = "http://getpost.itgid.info/index2.php";
const auth = "?auth=37A38D7d5b44Dd6D856478D8";
const action = "&action=";
//const action2 = "&action=2";
//onst action3 = "&action=3";
...
function t1() {
    ...
    xhttp.open("GET", webSite + auth + action + "1", true);
    xhttp.send();
}
...
function t2() {
    ...
    xhttp.open("GET", webSite + auth + action + "2&name=Nataliia", true);
    xhttp.send();
}
...
function t3() {
    ...
    xhttp.open("GET", webSite + auth + action + "3&num1=5&num2=15", true);
    xhttp.send();
}
...
function t4() {
    ...
    xhttp.open("GET", webSite + auth + action + "4&num1=5&num2=25", true);
    xhttp.send();
}
...
function t5() {
    ...
    xhttp.open("GET", webSite + auth + action + "5", true);
    xhttp.send();
}
...
function t6() {
    ...
    xhttp.open("GET", webSite + auth + action + "6&num1=5&num2=6", true);
    xhttp.send();
}
...
function t7() {
    ...
    xhttp.open("GET", webSite + auth + action + "7", true);
    xhttp.send();
}
...
function t8() {
    ...
    xhttp.open("GET", webSite + auth + action + "8&year=1994", true);
    xhttp.send();
}
...
function t9() {
    ...
    xhttp.open("GET", webSite + auth + action + "9&m=1&d=1&y=1", true);
    xhttp.send();
}
...
function t10() {
    ...
    xhttp.open("POST", webSite + auth + action + "1", true);
    xhttp.send();
}
...
function t11() {
    ...
    xhttp.open("POST", webSite + auth + action + "2&name=Nataliia", true);
    xhttp.send();
}
...
function t12() {
    ...
    xhttp.open("POST", webSite + auth + action + "3&num1=5&num2=15", true);
    xhttp.send();
}
...
function t13() {
    ...
    xhttp.open("POST", webSite + auth + action + "4&num1=5&num2=25", true);
    xhttp.send();
}
...
function t14() {
    ...
    xhttp.open("POST", webSite + auth + action + "5", true);
    xhttp.send();
}
...
function t15() {
    ...
    xhttp.open("POST", webSite + auth + action + "6&num1=5&num2=6", true);
    xhttp.send();
}
...
function t16() {
    ...
    xhttp.open("POST", webSite + auth + action + "7", true);
    xhttp.send();
}
...
function t17() {
    ...
    xhttp.open("POST", webSite + auth + action + "8&year=1994", true);
    xhttp.send();
}
...
function t18() {
    ...
    xhttp.open("POST", webSite + auth + action + "9&m=1&d=1&y=1", true);
    xhttp.send();
}
